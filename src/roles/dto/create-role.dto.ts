...
export class CreateRoleDto {
    @ApiProperty({ example: 'FARMACEUTICO', description: 'Nombre del rol en mayúsculas y sin espacios (usar _)' })
    ...
    @ApiPropertyOptional({ example: 'Gestiona el inventario farmacéutico del hospital' })
    @IsOptional()
